...
export const en: Record<keyof typeof ja, string> = {
  ...
  'subscribe.title': 'Oracle Mirror Premium\nMonthly subscription',
  'subscribe.body': 'The free plan allows up to {limit} AI Mirror uses per day.\nPremium removes the daily AI Mirror limit while the subscription is active. Self Reading remains available whether or not you subscribe.',
  'subscribe.monthly': '{price} for 1 month',
  'subscribe.autoRenew': 'Auto-renews every month',
  'subscribe.cta': 'Subscribe to Oracle Mirror Premium',
